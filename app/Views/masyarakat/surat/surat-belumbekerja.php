...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>Tambah Data Belum Bekerja</h1>
        <nav>
            <ol class="breadcrumb">
            </ol>
        </nav>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Surat Keterangan Belum Bekerja</h5>

                        <form action="/masyarakat/ajukansurat/suratbelumbekerja/generatesurat" method="post">
                            <?= csrf_field() ?>
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Tempat, Tanggal Lahir <span style="color:red">*</span></label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Status Pekerjaan <span style="color:red">*</span></label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Warga Negara <span style="color:red">*</span></label>
                                <div class="col-sm-10">
